...
function PACCladConsultationForm() {
  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      const payload = {
        ...
        requestType: "installation-consultation",
        notes: formData.get("notes") ?? "",
        productType: "Metal Wall Panel & Cladding Systems",
      };
    ...
    return (
      <div className="mx-auto max-w-xl px-4 py-16 text-center">
        ...
        <p className="mt-3 text-[15px] text-gray-600">
          We have received your metal wall panel consultation request and will respond within 1 business day.
        </p>
        <Link
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
      <div className="mb-12">
        <Link
          href="/products/pac-clad-panels"
          className="text-[13px] text-gray-600 hover:text-gray-900 mb-4 inline-block"
        >
          ← Back to Metal Wall Systems
        </Link>
        <h1 className="text-2xl font-semibold tracking-tight text-gray-900 sm:text-3xl mt-4">
          Installation Consultation
        </h1>
        <p className="mt-2 text-[15px] text-gray-500">
          Our professional installation teams deliver metal wall panel and cladding systems with quality workmanship. Submit your drawings and comments; we&apos;ll review and respond.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="rounded-2xl border border-gray-200/80 bg-white shadow-[0_1px_3px_rgba(0,0,0,0.04)]">
        ...
        <div className="space-y-6 p-6 md:p-8">
          ...
          <label className="block sm:col-span-2">
            <span className="block text-sm font-medium text-gray-900">Comments / what you&apos;d like</span>
            <textarea
              name="notes"
              rows={4}
              ...
              placeholder="Add comments on what you'd like—profile preference, scope, timeline, or any questions"
            />
          </label>
          <div>
            <span className="block text-sm font-medium text-gray-900">Drawings <span className="text-gray-400">*</span></span>
            <p className="mt-0.5 text-xs text-gray-500">Upload your drawings (PDF, PNG, or JPG). Up to 5 files, 10MB each. Add comments in the notes below.</p>
...
export default function PACCladConsultationPage() {
  return (
    <Suspense fallback={
      <div className="mx-auto max-w-2xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
