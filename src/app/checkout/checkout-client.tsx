    ...
    return (
      <div className="mx-auto max-w-xl px-4 py-16 text-center">
        ...
        <div className="mt-6 rounded-2xl border border-gray-200 bg-gray-50 p-6 text-left text-[15px] text-gray-700">
          ...
          <p className="mt-2">
            An account for the <strong>order portal</strong> is set up (or updated) for <strong>{submittedEmail}</strong>{" "}
            using the password you chose at checkout. To check status, open{" "}
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex flex-wrap items-start gap-3">
                  ...
                  >
                    {item.previewImageDataUrl ? (
                      ...
                      <img src={item.previewImageDataUrl} alt="" className="h-28 w-44 rounded-lg object-cover" />
                    ) : (
      ...
      <form
        ...
        className="rounded-2xl border border-gray-200/80 bg-white shadow-[0_1px_3px_rgba(0,0,0,0.04)]"
      >
        <div className="border-b border-gray-100 px-6 py-5 md:px-8">
          <h2 className="text-[15px] font-medium uppercase tracking-wider text-gray-500">Contact &amp; project details</h2>
        </div>
        <div className="space-y-6 p-6 md:p-8">
          ...
          <div className="rounded-xl border border-gray-200/80 bg-gray-50/50 p-6">
            ...
            <a
              href="/documents/All_Cladding_ACM_Panel_Pre_Estimate_Agreement.html"
              target="_blank"
              rel="noopener noreferrer"
              className="mt-3 inline-flex text-[15px] font-medium text-gray-900 underline hover:text-gray-700"
            >
