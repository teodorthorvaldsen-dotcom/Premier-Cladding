...
export const colors = [
  ...
  { id: "new-age-dark-bronze-mica", name: "New Age Dark Bronze Mica", code: "JY-2580", category: "Mica" as ColorCategory, series: "Micas" as ColorSeries, swatchHex: "#62615B", rgbApprox: "98 97 91", adderPerFt2: 0, availability: stock, leadTimeDaysRange: [2, 5] as [number, number] },
  {
    ...
    series: "Metallics" as ColorSeries,
    swatchHex: "#D7D7D8",
    swatchImage: "/images/acm/bright-silver-metallic-jy-3510.png",
    rgbApprox: "215 215 216",
    adderPerFt2: 1,
    availability: stock,
    leadTimeDaysRange: [2, 5] as [number, number],
  },
  {
    ...
    series: "Metallics" as ColorSeries,
    swatchHex: "#BFC0C0",
    swatchImage: "/images/acm/champagne-metallic-jy-3520.png",
    rgbApprox: "191 192 192",
    adderPerFt2: 1,
    availability: stock,
    leadTimeDaysRange: [2, 5] as [number, number],
  },
  {
    ...
    series: "Metallics" as ColorSeries,
    swatchHex: "#ADACAA",
    swatchImage: "/images/acm/pex-pewter-metallic-jy-3540.png",
    rgbApprox: "173 172 170",
    adderPerFt2: 1,
    availability: stock,
    leadTimeDaysRange: [2, 5] as [number, number],
  },
  {
    ...
    series: "Metallics" as ColorSeries,
    swatchHex: "#878583",
    swatchImage: "/images/acm/jlr-gray-metallic-jy-3550.png",
    rgbApprox: "135 133 131",
    adderPerFt2: 1,
    availability: stock,
    leadTimeDaysRange: [2, 5] as [number, number],
  },
  {
    ...
    series: "Metallics" as ColorSeries,
    swatchHex: "#53585B",
    swatchImage: "/images/acm/anthracite-silver-metallic-jy-3560.png",
    rgbApprox: "83 88 91",
    adderPerFt2: 1,
    availability: stock,
    leadTimeDaysRange: [2, 5] as [number, number],
  },
  {
    ...
    series: "Metallics" as ColorSeries,
    swatchHex: "#565758",
    swatchImage: "/images/acm/graphite-metallic-jy-3530.png",
    rgbApprox: "86 87 88",
    adderPerFt2: 1,
    availability: stock,
    leadTimeDaysRange: [2, 5] as [number, number],
  },
  {
    ...
    name: "Faux Zinc Lite",
    code: "JY-M130",
    category: "Metal" as ColorCategory,
    series: "Metal" as ColorSeries,
    swatchHex: "#B8BCBE",
    swatchImage: "/images/acm/faux-zinc-lite-jy-m130.png",
    rgbApprox: "approx. print",
    adderPerFt2: 0,
    availability: stock,
    leadTimeDaysRange: [2, 5] as [number, number],
  },
  {
    ...
    series: "Metal" as ColorSeries,
    swatchHex: "#8A8D8F",
    swatchImage: "/images/acm/faux-zinc-jy-m120.png",
    rgbApprox: "approx. print",
    adderPerFt2: 0,
    availability: stock,
    leadTimeDaysRange: [2, 5] as [number, number],
  },
  {
    ...
    code: "JY-M110",
    category: "Metal" as ColorCategory, series: "Metal" as ColorSeries,
    swatchHex: "#4F5254",
    swatchImage: "/images/acm/faux-zinc-graphite-jy-m110.png",
    rgbApprox: "approx. print",
    adderPerFt2: 0,
    availability: stock,
    leadTimeDaysRange: [2, 5] as [number, number],
  },
  {
    ...
    series: "Metal" as ColorSeries,
    swatchHex: "#965A3C",
    swatchImage: "/images/acm/tile-corten-jy-m140.png",
    rgbApprox: "approx. print",
    adderPerFt2: 0,
    availability: stock,
    leadTimeDaysRange: [2, 5] as [number, number],
  },
  {
    ...
    name: "Teak",
    code: "JY-W120",
    category: "Wood" as ColorCategory,
    series: "Wood" as ColorSeries,
    swatchHex: "#6B4E3D",
    swatchImage: "/images/acm/teak-jy-w120.png",
    rgbApprox: "approx. wood",
    adderPerFt2: 1.5,
    availability: stock,
    leadTimeDaysRange: [2, 5] as [number, number],
  },
  {
    ...
    series: "Wood" as ColorSeries,
    swatchHex: "#8D734A",
    swatchImage: "/images/acm/golden-oak-jy-w140.png",
    rgbApprox: "approx. wood",
    adderPerFt2: 1.5,
    availability: stock,
    leadTimeDaysRange: [2, 5] as [number, number],
  },
  {
    ...
    series: "Wood" as ColorSeries,
    swatchHex: "#4A3728",
    swatchImage: "/images/acm/dark-walnut-jy-w150.png",
    rgbApprox: "approx. wood",
    adderPerFt2: 1.5,
    availability: stock,
    leadTimeDaysRange: [2, 5] as [number, number],
  },
  {
    ...
    swatchHex: "#5C6B74",
    swatchImage: "/images/acm/blue-grey-jy-z110.png",
    rgbApprox: "Natural Zinc",
    adderPerFt2: 1.75,
    availability: mto,
  ...
  },
  {
    ...
    series: "Specialty" as ColorSeries,
    swatchHex: "#4B5054",
    swatchImage: "/images/acm/graphite-grey-jy-z100.png",
    rgbApprox: "Natural Zinc",
    adderPerFt2: 1.75,
    availability: mto,
    leadTimeDaysRange: [10, 21] as [number, number],
  },
  {
    ...
    series: "Specialty" as ColorSeries,
    swatchHex: "#B8B8B8",
    swatchImage: "/images/acm/hairline-clear-jy-h100.png",
    rgbApprox: "Specialty",
    adderPerFt2: 1.75,
    availability: mto,
    leadTimeDaysRange: [10, 21] as [number, number],
