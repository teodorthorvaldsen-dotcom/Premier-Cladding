  ...
  return (
    <div>
      ...
      <p className="mt-0.5 text-xs text-gray-500">
        Width and length in inches—you can clear a field and type your own size. If your drawing uses
        another reference, note it on the quote or attach a drawing.
      </p>
